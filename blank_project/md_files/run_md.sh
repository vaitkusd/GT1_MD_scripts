...
gmx_mpi grompp -f $MDP/md.mdp -p $CWD/topol_complex.top -c md_pullo1.cpt -n $CWD/index.ndx -o mdo1.tpr 

gmx_mpi mdrun -s mdo1.tpr -cpi md_pullo1.cpt

gmx_mpi grompp -f $MDP/md.mdp -p $CWD/topol_complex.top -c md_pullo2.cpt -n $CWD/index.ndx -o mdo2.tpr 

gmx_mpi mdrun -s mdo2.tpr -cpi md_pullo2.cpt
